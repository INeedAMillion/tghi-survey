...
q1 = st.radio(
    "How is your hair’s volume looking compared to 2-3 years ago?",
    [
...
q2 = st.radio(
    "Are wigs, weaves, or braids your 'crutch' right now?",
    [
...
q3 = st.radio(
    "How often are you using heat, colour, or chemicals?",
    [
        "a) Rarely or never.",
...
q4 = st.radio(
    "Does your hair affect your mood or confidence?",
    [
...
q5 = st.radio(
    "What is your main 'Hair Goal' right now?",
    [
        "a) Maintenance.",
        "b) Repair.",
        "c) Reversal.",
...
q6 = st.radio(
    "Have you ever seen a doctor or derm about your hair?",
    [
        "a) No, never.",
...
q8 = st.radio(
    "How long has your hair been a concern?",
    [
...
q9 = st.radio(
    "Have you been going through major changes (stress, baby, health)?",
    [
        "a) No major changes.",
